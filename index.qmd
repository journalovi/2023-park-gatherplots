...
*Discriminability*, on the other hand, is the ability for a user to perceive individual marks in a unit visualization.
Both of these metrics are particular relevant to unit visualizations, although discriminability has been proposed in prior work [@DBLP:journals/tvcg/LuLWYZDH22; @DBLP:journals/tvcg/VerasC20].
...
### Visual and Data Scalability

There is a clear upper bound to how many data points can be guaranteed to be visible in a gatherplot.
